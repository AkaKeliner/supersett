...
Revision ID: 406a6222d178
Revises: 1cf8e4344e2b
Create Date: 2024-03-06 09:10:53.949170

"""

# revision identifiers, used by Alembic.
revision = '406a6222d178'
...
def upgrade():
    ...
    sa.Column('workspace_title', sa.String(length=500), nullable=True),
    ...
    sa.ForeignKeyConstraint(['parent_id'], ['workspaces.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('uuid')
    )
    op.create_table('workspace_dashboards',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_table('workspace_slices',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('workspace_id', sa.Integer(), nullable=True),
    ...
    sa.ForeignKeyConstraint(['dataset_id'], ['sl_datasets.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['workspace_id'], ['workspaces.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    op.add_column('report_schedule', sa.Column('workspace_id', sa.Integer(), nullable=True))
    op.alter_column('report_schedule', 'extra_json',
               existing_type=sa.TEXT(),
               nullable=True)
    op.drop_index('ix_creation_method', table_name='report_schedule')
    op.create_foreign_key(None, 'report_schedule', 'workspaces', ['workspace_id'], ['id'])
    ...
    op.alter_column('sl_columns', 'is_temporal',
               existing_type=sa.BOOLEAN(),
               nullable=True)
    op.add_column('sl_datasets', sa.Column('workspace_id', sa.Integer(), nullable=True))
    op.create_foreign_key(None, 'sl_datasets', 'workspaces', ['workspace_id'], ['id'])
...
def downgrade():
    ...
    op.drop_column('sl_datasets', 'workspace_id')
    op.alter_column('sl_columns', 'is_temporal',
               existing_type=sa.BOOLEAN(),
               nullable=False)
    op.alter_column('sl_columns', 'is_spatial',
    ...
    op.alter_column('report_schedule', 'extra_json',
               existing_type=sa.TEXT(),
               nullable=False)
    op.drop_column('report_schedule', 'workspace_id')
    ...
    op.drop_table('workspace_slices')
    op.drop_table('workspace_roles')
    op.drop_table('workspace_dashboards')
